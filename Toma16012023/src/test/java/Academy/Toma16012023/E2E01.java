...
public class E2E01 extends BaseTest02 {
	...
	public void verifyArticlePublished()
	{
		...
		//02. 
				...
				/*allArticles.stream().filter(oneArticle -> oneArticle.findElement(By.cssSelector("h1")).getText().equals(articleTitle))
				.findFirst().orElse(null);*/
				
				boolean articlePresent = allArticles.stream().anyMatch(oneArticle -> oneArticle.findElement(By.cssSelector("h1")).getText().equals(articleTitle));
