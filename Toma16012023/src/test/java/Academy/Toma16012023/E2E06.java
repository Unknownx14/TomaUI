...
public class E2E06 extends BaseTest02 {
...
/*		String userEmail = "jovan.kovacevic@hotmail.com";
		...
		papo.clickNewPostButton();
		 ...
		 articleTitle = input.get("articleTitle")+System.currentTimeMillis();
	/*	String articleAbout = "About01";
		String articleText = "Text01";
		String articleTag = "Tag01";*/

		papo.publishAsrticle(articleTitle, input.get("articleAbout"), input.get("articleText"), input.get("articleTag"));
...
/*		HashMap<String, String> hmap01 = new HashMap<String, String>();
		...
		List<HashMap<String, String>> data = getJsonDataToHashMap(System.getProperty("user.dir") + "\\src\\test\\java\\Academy\\Data\\PublishArticle02.json");
